...
//  * @param {string} href
//  */
// export function cleanUrl(sanitize: any, base: string, href: string) {
//   if (sanitize) {
//     let prot;
//     try {
...
export function splitCells(tableRow: string, count: number) {
  ...
  const row = tableRow.replace(/\|/g, (_match: any, offset: any, str: { [x: string]: string; }) => {
      let escaped = false,
        curr = offset;
...
export function findClosingBracket(str: string | any[], b: any[]) {
