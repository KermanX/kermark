...
export class Lexer {
   ...
   */
  static lexInline(src: string, options) {
    const lexer = new Lexer(options);
   ...
   * Lexing
   */
  blockTokens(src: string, tokens: Tokens) {
    if (this.options.pedantic) {
  ...
  inline(src: string, tokens: Tokens) {
   ...
   * Lexing/Compiling
   */
  inlineTokens(src: string, tokens: Tokens) {
